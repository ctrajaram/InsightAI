...
console.log(`Summarize API: Using ${serviceRoleKey ? 'service role' : 'missing'} key for admin client`);
console.log(`Summarize API: Using ${openaiApiKey ? 'valid' : 'missing'} OpenAI API key`);
